...
@Component({
  selector: 'app-main-popup-criteria',
  templateUrl: './main-popup-criteria.component.html',
  styleUrls: ['./main-popup-criteria.component.css']
})
export class MainPopupCriteriaComponent implements OnInit {
  ...
  readSequence() {
    ...
    this.serviceProviderService.post('groupby/read', { permission: this.permission,title: 'mainpopup' }).subscribe(data => {
      let model: any = {};
      model = data;
