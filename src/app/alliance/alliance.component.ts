...
export class AllianceComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('alliancePage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('alliancePage'));
  ...
  read() {
    ...
    this.serviceProviderService.post('alliance/read', this.criteriaModel).subscribe(data => {
      setTimeout(() => {
        let model: any = {};
        model = data;
