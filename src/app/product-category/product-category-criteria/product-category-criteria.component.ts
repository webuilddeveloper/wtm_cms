...
@Component({
  selector: 'app-product-category-criteria',
  templateUrl: './product-category-criteria.component.html',
  styleUrls: ['./product-category-criteria.component.css']
})
export class ProductCategoryCriteriaComponent implements OnInit {
