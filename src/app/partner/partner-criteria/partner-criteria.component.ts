...
@Component({
  selector: 'app-partner-criteria',
  templateUrl: './partner-criteria.component.html',
  styleUrls: ['./partner-criteria.component.css']
})
export class PartnerCriteriaComponent implements OnInit {
