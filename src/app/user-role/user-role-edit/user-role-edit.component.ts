...
export class UserRoleEditComponent implements OnInit {
      ...
      this.serviceProviderService.postByPass('register/permission/read', { code: this.code }).subscribe(data => {
        ...
        this.messageInput.forEach(element => {
          ...
          if (element.VerifyApprovedUserPage)
            element.title = element.VerifyApprovedUserCategoryList[0].title;
          if (element.trainingInstitutePage)
            element.title = element.trainingInstituteCategoryList[0].title;
  ...
  readImportantCategory() {
    this.serviceProviderService.post('m/important/category/read', {}).subscribe(data => {
      let model: any = {};
      model = data;
      console.log('model', model);
      model.objectData.forEach(element => {
        this.importantCategory.push({ value: element.code, display: element.title });
      });
      // console.log('list', this.newCategory);
    }, err => { });
  }
  ...
  readKnowledgeVetCategory() {
    this.serviceProviderService.post('m/knowledgeVet/category/read', {}).subscribe(data => {
      let model: any = {};
      model = data;
      console.log('model', model);
      model.objectData.forEach(element => {
        this.knowledgeVetCategory.push({ value: element.code, display: element.title });
      });
      // console.log('list', this.newCategory);
    }, err => { });
  }
  ...
  readExaminationCategory() {
    this.serviceProviderService.post('m/examination/category/read', {}).subscribe(data => {
      let model: any = {};
      model = data;
      console.log('model', model);
      model.objectData.forEach(element => {
        this.examinationCategory.push({ value: element.code, display: element.title });
      });
      // console.log('list', this.newCategory);
    }, err => { });
  }
  ...
  readImageEventCategory() {
    this.serviceProviderService.post('m/imageEvent/category/read', {}).subscribe(data => {
      let model: any = {};
      model = data;
      console.log('imageEvent', model);
      model.objectData.forEach(element => {
        this.imageEventCategory.push({ value: element.code, display: element.title });
      });
      // console.log('list', this.newCategory);
    }, err => { });
  }
  ...
  readEventAbroadCategory() {
    this.serviceProviderService.post('m/eventAbroad/category/read', {}).subscribe(data => {
      let model: any = {};
      model = data;
      console.log('eventAbroad', model);
      model.objectData.forEach(element => {
        this.eventAbroadCategory.push({ value: element.code, display: element.title });
      });
      // console.log('list', this.newCategory);
    }, err => { });
  }
  ...
  readVetEnewsCategory() {
    this.serviceProviderService.post('m/vetEnews/category/read', {}).subscribe(data => {
      let model: any = {};
      model = data;
      console.log('vetEnews', model);
      model.objectData.forEach(element => {
        this.vetEnewsCategory.push({ value: element.code, display: element.title });
      });
      // console.log('list', this.newCategory);
    }, err => { });
  }
  ...
  readLawCategory() {
    this.serviceProviderService.post('m/law/category/read', {}).subscribe(data => {
      let model: any = {};
      model = data;
      model.objectData.forEach(element => {
        this.lawCategory.push({ value: element.code, display: element.title });
      });
      // console.log('list', this.newCategory);
    }, err => { });
  }
  ...
  readExpertBranchCategory() {
    this.serviceProviderService.post('m/expertBranch/category/read', {}).subscribe(data => {
      let model: any = {};
      model = data;
      model.objectData.forEach(element => {
        this.expertBranchCategory.push({ value: element.code, display: element.title });
      });
      // console.log('list', this.newCategory);
    }, err => { });
  }
  ...
  readVerifyApprovedUserCategory() {
    this.serviceProviderService.post('m/verifyApprovedUser/category/read', {}).subscribe(data => {
      let model: any = {};
      model = data;
      model.objectData.forEach(element => {
        this.verifyApprovedUserCategory.push({ value: element.code, display: element.title });
      });
      // console.log('list', this.newCategory);
    }, err => { });
  }
  ...
  readTrainingInstituteCategory() {
    this.serviceProviderService.post('m/trainingInstitute/category/read', {}).subscribe(data => {
      let model: any = {};
      model = data;
      model.objectData.forEach(element => {
        this.trainingInstituteCategory.push({ value: element.code, display: element.title });
      });
      // console.log('list', this.newCategory);
    }, err => { });
  }
  ...
  readSeminarCategory() {
    this.serviceProviderService.post('m/seminar/category/read', {}).subscribe(data => {
      let model: any = {};
      model = data;
      model.objectData.forEach(element => {
        this.seminarCategory.push({ value: element.code, display: element.title });
      });
      // console.log('list', this.newCategory);
    }, err => { });
  }
  ...
  readProductCategory() {
    this.serviceProviderService.post('m/product/category/read', {}).subscribe(data => {
      let model: any = {};
      model = data;
      model.objectData.forEach(element => {
        this.productCategory.push({ value: element.code, display: element.title });
      });
      // console.log('list', this.newCategory);
    }, err => { });
  }
  ...
  readEmployeeCategory() {
    this.serviceProviderService.post('m/employee/category/read', {}).subscribe(data => {
      let model: any = {};
      model = data;
      model.objectData.forEach(element => {
        this.employeeCategory.push({ value: element.code, display: element.title });
      });
      // console.log('list', this.newCategory);
    }, err => { });
  }
  ...
  chooseAllEvertThing() {
    ...
    if (this.editModel.importantPage)
      this.chooseAllImportant();
    ...
    if (this.editModel.knowledgeVetPage)
      this.chooseAllKnowledgeVet();
    ...
    if (this.editModel.examinationPage)
      this.chooseAllExamination();

    if (this.editModel.imageEventPage)
      this.chooseAllImageEvent();

    if (this.editModel.eventAbroadPage)
      this.chooseAllEventAbroad();

    if (this.editModel.vetEnewsPage)
      this.chooseAllVetEnews();

    if (this.editModel.lawPage)
      this.chooseAllLaw();

    if (this.editModel.expertBranchPage)
      this.chooseAllExpertBranch();

    // if (this.editModel.verifyApprovedUserPage)
    //   this.chooseAllVerifyApprovedUser();

    if (this.editModel.trainingInstitutePage)
      this.chooseAllTrainingInstitute();

    if (this.editModel.seminarPage)
      this.chooseAllSeminar();

    if (this.editModel.productPage)
      this.chooseAllProduct();

    if (this.editModel.employeePage)
      this.chooseAllEmployee();
  }
  ...
  async chooseAllImportant() {
    await this.importantCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'ข้อมูลสำคัญสำหรับสมาชิก') === -1) {
        this.messageInput.splice(0, 0, { page: 'ข้อมูลสำคัญสำหรับสมาชิก', category: element.value, title: element.display, importantPage: true });
        // console.log("element doesn't exist");
      }
      else {
        // console.log("element found");
  ...
  async chooseAllKnowledge() {
    await this.knowledgeCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'คลังเอกสาร') === -1) {
        this.messageInput.splice(0, 0, { page: 'คลังเอกสาร', category: element.value, title: element.display, knowledgePage: true });
        // console.log("element doesn't exist");
      }
      else {
        // console.log("element found");
  ...
  async chooseAllKnowledgeVet() {
    await this.knowledgeVetCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'สารสัตวแพทยสภา') === -1) {
        this.messageInput.splice(0, 0, { page: 'สารสัตวแพทยสภา', category: element.value, title: element.display, knowledgeVetPage: true });
        // console.log("element doesn't exist");
      }
      else {
        // console.log("element found");
  ...
  async chooseAllExamination() {
    await this.examinationCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'แบบสำรวจ') === -1) {
        this.messageInput.splice(0, 0, { page: 'แบบสำรวจ', category: element.value, title: element.display, examinationPage: true });
        // console.log("element doesn't exist");
      }
      else {
        // console.log("element found");
  ...
  async chooseAllImageEvent() {
    await this.imageEventCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'ภาพกิจกรรม') === -1) {
        this.messageInput.splice(0, 0, { page: 'ภาพกิจกรรม', category: element.value, title: element.display, imageEventPage: true });
        // console.log("element doesn't exist");
      }
      else {
        // console.log("element found");
  ...
  async chooseAllEventAbroad() {
    await this.eventAbroadCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'ภาพกิจกรรม') === -1) {
        this.messageInput.splice(0, 0, { page: 'ภาพกิจกรรม', category: element.value, title: element.display, eventAbroadPage: true });
        // console.log("element doesn't exist");
      }
      else {
        // console.log("element found");
  ...
  async chooseAllVetEnews() {
    await this.vetEnewsCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'สัตวแพทยสภาอีนิวส์') === -1) {
        this.messageInput.splice(0, 0, { page: 'สัตวแพทยสภาอีนิวส์', category: element.value, title: element.display, vetEnewsPage: true });
        // console.log("element doesn't exist");
      }
      else {
        // console.log("element found");
  ...
  async chooseAllLaw() {
    await this.lawCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'กฎหมาย') === -1) {
        this.messageInput.splice(0, 0, { page: 'กฎหมาย', category: element.value, title: element.display, lawPage: true });
        // console.log("element doesn't exist");
      }
      else {
        // console.log("element found");
  ...
  async chooseAllExpertBranch() {
    await this.expertBranchCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'ตรวจสอบรายชื่อผู้ได้รับอนุมัติบัตรและวุฒิบัตร') === -1) {
        this.messageInput.splice(0, 0, { page: 'ตรวจสอบรายชื่อผู้ได้รับอนุมัติบัตรและวุฒิบัตร', category: element.value, title: element.display, expertBranchPage: true });
        // console.log("element doesn't exist");
      }
      else {
        // console.log("element found");
  ...
  async chooseAllTrainingInstitute() {
    await this.trainingInstituteCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'การฝึกอบรม') === -1) {
        this.messageInput.splice(0, 0, { page: 'การฝึกอบรม', category: element.value, title: element.display, trainingInstitutePage: true });
        // console.log("element doesn't exist");
      }
      else {
        // console.log("element found");
  ...
  async chooseAllSeminar() {
    await this.seminarCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'สัมมนา') === -1) {
        this.messageInput.splice(0, 0, { page: 'สัมมนา', category: element.value, title: element.display, seminarPage: true });
      }
      else {
        // console.log("element found");
      }
  ...
  async chooseAllProduct() {
    await this.productCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'ผลงาน') === -1) {
        this.messageInput.splice(0, 0, { page: 'ผลงาน', category: element.value, title: element.display, productPage: true });
      }
      else {
        // console.log("element found");
      }
  ...
  async chooseAllEmployee() {
    await this.employeeCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'พนักงาน') === -1) {
        this.messageInput.splice(0, 0, { page: 'พนักงาน', category: element.value, title: element.display, employeePage: true });
      }
      else {
        // console.log("element found");
      }
  ...
  async chooseAllCooperativeForm() {
    await this.cooperativeFormCategory.forEach(element => {
      ...
      if (this.messageInput.findIndex(item => item.category == element.value && item.page == 'ดาวน์โหลดเอกสาร') === -1) {
        this.messageInput.splice(0, 0, { page: 'ดาวน์โหลดเอกสาร', category: element.value, title: element.display, cooperativeFormPage: true });
        // console.log("element doesn't exist");
      }
      else {
        // console.log("element found");
    ...
    if (category != '') {
      if (this.messageInput.findIndex(item => item.category == category && item.page == page) === -1) {
        ...
        if (param == 'importantPage') {
          if (this.importantCategory.findIndex(item => item.value == category) != -1) {
            let idx = this.importantCategory.findIndex(item => item.value == category);
            this.messageInput.splice(0, 0, { page: page, category: category, title: this.importantCategory[idx].display, importantPage: true });
          }
        }
          ...
          if (this.knowledgeVetCategory.findIndex(item => item.value == category) != -1) {
            let idx = this.knowledgeVetCategory.findIndex(item => item.value == category);
            this.messageInput.splice(0, 0, { page: page, category: category, title: this.knowledgeVetCategory[idx].display, knowledgeVetPage: true });
          }
        }
          ...
          if (this.examinationCategory.findIndex(item => item.value == category) != -1) {
            let idx = this.examinationCategory.findIndex(item => item.value == category);
            this.messageInput.splice(0, 0, { page: page, category: category, title: this.examinationCategory[idx].display, examinationPage: true });
          }
        }
          ...
          if (this.imageEventCategory.findIndex(item => item.value == category) != -1) {
            let idx = this.imageEventCategory.findIndex(item => item.value == category);
            this.messageInput.splice(0, 0, { page: page, category: category, title: this.imageEventCategory[idx].display, imageEventPage: true });
          }
        }
        else if (param == 'eventAbroadPage') {
          if (this.eventAbroadCategory.findIndex(item => item.value == category) != -1) {
            let idx = this.eventAbroadCategory.findIndex(item => item.value == category);
            this.messageInput.splice(0, 0, { page: page, category: category, title: this.eventAbroadCategory[idx].display, eventAbroadPage: true });
          }
        }
        else if (param == 'vetEnewsPage') {
          if (this.vetEnewsCategory.findIndex(item => item.value == category) != -1) {
            let idx = this.vetEnewsCategory.findIndex(item => item.value == category);
            this.messageInput.splice(0, 0, { page: page, category: category, title: this.vetEnewsCategory[idx].display, vetEnewsPage: true });
          }
        }
        else if (param == 'lawPage') {
          if (this.lawCategory.findIndex(item => item.value == category) != -1) {
            let idx = this.lawCategory.findIndex(item => item.value == category);
            this.messageInput.splice(0, 0, { page: page, category: category, title: this.lawCategory[idx].display, lawPage: true });
          }
        }
        else if (param == 'expertBranchPage') {
          if (this.expertBranchCategory.findIndex(item => item.value == category) != -1) {
            let idx = this.expertBranchCategory.findIndex(item => item.value == category);
            this.messageInput.splice(0, 0, { page: page, category: category, title: this.expertBranchCategory[idx].display, expertBranchPage: true });
          }
        }
        ...
        // }
          ...
          if (this.trainingInstituteCategory.findIndex(item => item.value == category) != -1) {
            let idx = this.trainingInstituteCategory.findIndex(item => item.value == category);
            this.messageInput.splice(0, 0, { page: page, category: category, title: this.trainingInstituteCategory[idx].display, trainingInstitutePage: true });
          }
        }
        else if (param == 'seminarPage') {
          if (this.seminarCategory.findIndex(item => item.value == category) != -1) {
            let idx = this.seminarCategory.findIndex(item => item.value == category);
            this.messageInput.splice(0, 0, { page: page, category: category, title: this.seminarCategory[idx].display, seminarPage: true });
          }
        }
        else if (param == 'productPage') {
          if (this.productCategory.findIndex(item => item.value == category) != -1) {
            let idx = this.productCategory.findIndex(item => item.value == category);
            this.messageInput.splice(0, 0, { page: page, category: category, title: this.productCategory[idx].display, productPage: true });
          }
        }
        else if (param == 'employeePage') {
          if (this.employeeCategory.findIndex(item => item.value == category) != -1) {
            let idx = this.employeeCategory.findIndex(item => item.value == category);
            this.messageInput.splice(0, 0, { page: page, category: category, title: this.employeeCategory[idx].display, employeePage: true });
          }
        }
        // console.log("element doesn't exist");
      }
