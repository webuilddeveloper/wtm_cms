...
@Component({
  selector: 'app-report-about-us-criteria',
  templateUrl: './report-about-us-criteria.component.html',
  styleUrls: ['./report-about-us-criteria.component.css']
})
export class ReportAboutUsCriteriaComponent implements OnInit {
  ...
  readCategory() {
    ...
    this.criteriaModel.page = 'aboutUsCategory';
