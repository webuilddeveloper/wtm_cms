...
@Component({
  selector: 'app-report-about-us',
  templateUrl: './report-about-us.component.html',
  styleUrls: ['./report-about-us.component.css']
})
export class ReportAboutUsComponent implements OnInit {
