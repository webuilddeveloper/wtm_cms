...
@Component({
  selector: 'app-report-about-us-list',
  templateUrl: './report-about-us-list.component.html',
  styleUrls: ['./report-about-us-list.component.css']
})
export class ReportAboutUsListComponent implements OnInit {
  ...
  exportAsXLSX(): void {
    ...
    this.criteriaModel.page = 'aboutUs'
    this.serviceProviderService.postStatistics('read', this.criteriaModel).subscribe(data => {
      let model: any = {};
      let result:any = [];
      model = data;
      ...
      this.excelService.exportAsExcelFile(result, 'รายงานยอดอ่านเกี่ยวกับเรา');
    }, err => {
