...
export class RotationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('rotationPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('rotationPage'));
  ...
  read() {
    ...
    this.serviceProviderService.post('rotation/read', this.criteriaModel).subscribe(data => {
      setTimeout(() => {
        let model: any = {};
        model = data;
