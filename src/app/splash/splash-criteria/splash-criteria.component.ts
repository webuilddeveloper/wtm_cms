...
@Component({
  selector: 'app-splash-criteria',
  templateUrl: './splash-criteria.component.html',
  styleUrls: ['./splash-criteria.component.css']
})
export class SplashCriteriaComponent implements OnInit {
  ...
  readSequence() {
    ...
    this.serviceProviderService.post('groupby/read', { permission: this.permission,title: 'splash' }).subscribe(data => {
      let model: any = {};
      model = data;
