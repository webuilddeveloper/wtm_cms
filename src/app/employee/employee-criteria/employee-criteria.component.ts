...
@Component({
  ...
  styleUrls: ['./employee-criteria.component.css']
})
export class EmployeeCriteriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('employeePage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('employeePage'));
  ...
  readSequence() {
    this.criteriaModel.permission = this.permission;
    this.serviceProviderService.post('groupby/read', { permission: this.permission, title: 'employee' }).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  readCategory() {
    this.criteriaModel.permission = this.permission;
    this.serviceProviderService.post('employee/category/read', this.criteriaModel).subscribe(data => {
      let model: any = {};
      model = data;
