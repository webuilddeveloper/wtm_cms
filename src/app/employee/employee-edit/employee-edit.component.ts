...
export class EmployeeEditComponent implements OnInit {
  ...
  constructor(private apiProviderService: ApiProviderService
    ...
    this.url = {
      create: this.apiProviderService.employee.create,
      read: this.apiProviderService.employee.read,
      update: this.apiProviderService.employee.update,
      delete: this.apiProviderService.employee.delete,
      category: {
        create: this.apiProviderService.employee.category.create,
        read: this.apiProviderService.employee.category.read,
        update: this.apiProviderService.employee.category.update,
        delete: this.apiProviderService.employee.category.delete
      },
      gallery: {
        create: this.apiProviderService.employee.gallery.create,
        read: this.apiProviderService.employee.gallery.read,
        update: this.apiProviderService.employee.gallery.update,
        delete: this.apiProviderService.employee.gallery.delete
      },
      galleryFile: {
        create: this.apiProviderService.employee.galleryFile.create,
        read: this.apiProviderService.employee.galleryFile.read,
        update: this.apiProviderService.employee.galleryFile.update,
        delete: this.apiProviderService.employee.galleryFile.delete
      }
    }
  ...
  ngOnInit(): void {
    this.permission = this.permissionService.readPermission('employeePage');
    this.permissionList = this.permissionService.readLocalStorage('employeePage');
  ...
  readCategory(param: string) {
    ...
    if (this.editModel.language != '') {
      this.serviceProviderService.post('employee/category/read', { language: param, permission: this.permission }).subscribe(data => {
        let model: any = {};
        model = data;
  ...
  galleryRead() {
    this.serviceProviderService.post('m/employee/gallery/read', { code: this.editModel.code }).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  galleryFileRead() {
    this.serviceProviderService.post('m/employee/galleryFile/read', { code: this.editModel.code }).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  exportAsXLSX(): void {
    this.serviceProviderService.post('employee/comment/read', { skip: 0, limit: 999999, code: this.code }).subscribe(data => {
      let model: any = {};
      let result: any = [];
      model = data;
