...
@Component({
  selector: 'app-banner-criteria',
  templateUrl: './banner-criteria.component.html',
  styleUrls: ['./banner-criteria.component.css']
})
export class BannerCriteriaComponent implements OnInit {
