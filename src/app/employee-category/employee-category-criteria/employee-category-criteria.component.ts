...
@Component({
  selector: 'app-employee-category-criteria',
  templateUrl: './employee-category-criteria.component.html',
  styleUrls: ['./employee-category-criteria.component.css']
})
export class EmployeeCategoryCriteriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('employeeCategoryPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('employeeCategoryPage'));
