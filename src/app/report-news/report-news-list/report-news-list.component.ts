...
@Component({
  selector: 'app-report-news-list',
  templateUrl: './report-news-list.component.html',
  styleUrls: ['./report-news-list.component.css']
})
export class ReportNewsListComponent implements OnInit {
  ...
  exportAsXLSX(): void {
    ...
    this.serviceProviderService.postStatisticsV2('read', this.criteriaModel).subscribe(data => {
      ...
      this.excelService.exportAsExcelFile(result, 'รายงานยอดอ่านข่าว');
    }, err => {
