...
@Component({
  ...
  styleUrls: ['./work-process-edit.component.css']
})
export class WorkProcessEditComponent implements OnInit {
  ...
  imageFile: string = '';
  code: any;
  title = 'เพิ่มข้อมูลกระบวนการทำงาน';
  ...
  constructor(private apiProviderService: ApiProviderService
    ...
    this.url = {
      create: this.apiProviderService.workprocess.create,
      read: this.apiProviderService.workprocess.read,
      update: this.apiProviderService.workprocess.update,
      delete: this.apiProviderService.workprocess.delete,
      category: {
        create: this.apiProviderService.workprocess.category.create,
        read: this.apiProviderService.workprocess.category.read,
        update: this.apiProviderService.workprocess.category.update,
        delete: this.apiProviderService.workprocess.category.delete
      },
      gallery: {
        create: this.apiProviderService.workprocess.gallery.create,
        read: this.apiProviderService.workprocess.gallery.read,
        update: this.apiProviderService.workprocess.gallery.update,
        delete: this.apiProviderService.workprocess.gallery.delete
      },
      galleryFile: {
        create: this.apiProviderService.workprocess.galleryFile.create,
        read: this.apiProviderService.workprocess.galleryFile.read,
        update: this.apiProviderService.workprocess.galleryFile.update,
        delete: this.apiProviderService.workprocess.galleryFile.delete
      }
    }
  ...
  ngOnInit(): void {
    this.permission = this.permissionService.readPermission('workProcessPage');
    this.permissionList = this.permissionService.readLocalStorage('workProcessPage');
    ...
    this.activetedRoute.queryParams.subscribe(params => {
      ...
      if (this.code != '') {
        this.title = 'แก้ไขข้อมูลกระบวนการทำงาน';
        this.read();
      } else {
  ...
  readCategory(param: string) {
    ...
    if (this.editModel.language != '') {
      this.serviceProviderService.post('workProcess/category/read', { language: param, permission: this.permission }).subscribe(data => {
        let model: any = {};
        model = data;
  ...
  galleryRead() {
    this.serviceProviderService.post('m/workProcess/gallery/read', { code: this.editModel.code }).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  galleryFileRead() {
    this.serviceProviderService.post('m/workProcess/galleryFile/read', { code: this.editModel.code }).subscribe(data => {
      let model: any = {};
      model = data;
  ...
  exportAsXLSX(): void {
    this.serviceProviderService.post('workProcess/comment/read', { skip: 0, limit: 999999, code: this.code }).subscribe(data => {
      let model: any = {};
      let result: any = [];
      model = data;
  ...
  back() {
    this.router.navigate(['work-process'], { skipLocationChange: true });
  }
}
