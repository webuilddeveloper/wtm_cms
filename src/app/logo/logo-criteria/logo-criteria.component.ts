...
@Component({
  selector: 'app-logo-criteria',
  templateUrl: './logo-criteria.component.html',
  styleUrls: ['./logo-criteria.component.css']
})
export class LogoCriteriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // if (localStorage.getItem('logoPage') != null) {
    //   let model: any = [];
    //   model = JSON.parse(localStorage.getItem('logoPage'));
