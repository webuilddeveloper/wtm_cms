...
@Component({
  selector: 'app-report-reporter',
  templateUrl: './report-reporter.component.html',
  styleUrls: ['./report-reporter.component.css']
})
export class ReportReporterComponent implements OnInit {
