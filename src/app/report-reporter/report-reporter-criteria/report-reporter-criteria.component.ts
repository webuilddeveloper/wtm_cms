...
@Component({
  selector: 'app-report-reporter-criteria',
  templateUrl: './report-reporter-criteria.component.html',
  styleUrls: ['./report-reporter-criteria.component.css']
})
export class ReportReporterCriteriaComponent implements OnInit {
