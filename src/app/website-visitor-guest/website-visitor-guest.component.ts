...
@Component({
  selector: 'app-website-visitor-guest',
  templateUrl: './website-visitor-guest.component.html',
  styleUrls: ['./website-visitor-guest.component.css']
})
export class WebsiteVisitorGuestComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('websitevisitorPage') != null) {
      let model: any = [];
      model = JSON.parse(localStorage.getItem('websitevisitorPage'));
