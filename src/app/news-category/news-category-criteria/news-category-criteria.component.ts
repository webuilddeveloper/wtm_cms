...
@Component({
  selector: 'app-news-category-criteria',
  templateUrl: './news-category-criteria.component.html',
  styleUrls: ['./news-category-criteria.component.css']
})
export class NewsCategoryCriteriaComponent implements OnInit {
